...
g++ -c -g lab4.cpp -o lab4.o -std=c++11

g++ -o lab4 bcrypt/blf.o bcrypt/bcrypt.o httpreq/httpreq.o httpreq/httpresp.o ThreadSafeStructures/ThreadSafeKVStore.o ThreadSafeStructures/ThreadSafeListenerQueue.o ThreadPoolServer.o lab4.o -lpthread
