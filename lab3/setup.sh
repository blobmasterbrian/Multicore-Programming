...
g++ -c -g lab3.cpp -o lab3.o -std=c++11

g++ -o lab3 bcrypt/blf.o bcrypt/bcrypt.o httpreq/httpreq.o httpreq/httpresp.o ThreadSafeStructures/ThreadSafeKVStore.o ThreadSafeStructures/ThreadSafeListenerQueue.o ThreadPoolServer.o lab3.o -lpthread
